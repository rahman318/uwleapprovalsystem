...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 🔹 DEBUG MODE: guna dummy token supaya POST tak fail
      const dummyToken = "testtoken123456"; 

      const res = await axios.post(
        `https://backenduwleapprovalsystem.onrender.com/api/auth/reset-password/${dummyToken}`,
        { password }
      );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        <h2 className="text-2xl font-semibold text-center mb-6">Reset Kata Laluan (Debug)</h2>
